...
::: {align="right" style="font-size: 16px;"}
Alunos:
:::
...
2.  ::: {style="font-size: 16px;"}
    Maximize a taxa de dados e tinta;
    :::

3.  ::: {style="font-size: 16px;"}
...
::: {align="justify" style="font-size: 16px;"}
     Sendo assim, tomaremos como base esses três grandes fundamentos (1) otimização de elementos gráficos para destacar informações, 2) *estrutura gráfica_storytelling*, 3) fidelidade aos dados) e relataremos gráficos não-efetivos que encontramos em nossas pesquisas.
:::
...
> ::: {align="center" style="font-size: 14px;"}
> Figura 5: Ilustração de Gráfico de Dois Eixos Verticais. Fonte: Flowingdata.
> :::
...
> ::: {align="center" style="font-size: 14px;"}
> Figura 6: Taxa de divórcio a cada 1000 pessoas na cidade de Maine (EUA) se correlaciona com o consumo de libras *per capita* de margarina entre os anos 2000 e 2009. Fonte: Flowingdata.
> :::
